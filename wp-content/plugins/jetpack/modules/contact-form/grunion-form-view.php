...
<style>
	...
	body { background: #F9F9F9; font-family:"Lucida Grande",Verdana,Arial,"Bitstream Vera Sans",sans-serif; font-size:12px; color: #1c1e20; line-height:1.5em; height: 100%; width: 100%; padding-bottom: 20px !important; }
	...
	/* Core */
	#media-upload-header { border-bottom: 1px solid #DFDFDF; font-weight:bold; margin:0; padding:3px 5px 0 5px; position:relative; background: #f5f7f8; }
	...
	#sidemenu a { text-decoration:none; border-top: 1px solid #f5f7f8; display:block; float:left; line-height:28px; padding:0 13px; outline: none; }
	...
	.fb-form-case { background: #f5f7f8; padding: 13px; border: 1px solid #E2E2E2; width: 336px; -moz-border-radius:4px; border-radius:4px; -webkit-border-radius:4px }
	...
	.fb-new-fields { position: relative; border: 1px dashed #f5f7f8; background: #f5f7f8; padding: 4px 10px 10px; cursor: default; }
	...
	.fb-reorder:hover div { display: block !important; width: 130px !important; position: absolute; top: 0; right: 0; z-index: 200; padding: 5px 10px; color: #555; font-size: 11px; background: #f5f7f8; border: 1px solid #CCC; -moz-border-radius:4px; border-radius:4px; -webkit-border-radius:4px; }
	...
	.fb-success { position: absolute; top: -3px; right: 100px; padding: 6px 23px 4px 23px; background: #FFFFE0; font-weight: normal; border: 1px solid #E6DB55; color: #1c1e20; -moz-border-radius:4px; border-radius:4px; -webkit-border-radius:4px; }
	.right { float: right; }
	/* rtl */
